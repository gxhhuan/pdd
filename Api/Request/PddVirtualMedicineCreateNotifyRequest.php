...
class PddVirtualMedicineCreateNotifyRequest extends PopBaseHttpRequest{
    ...
    /**
     * @JsonProperty(\Com\Pdd\Pop\Sdk\Api\Request\PddVirtualMedicineCreateNotifyRequest_PhysicalFunction, "physical_function")
     */
    private $physicalFunction;

    /**
     * @JsonProperty(List<\Com\Pdd\Pop\Sdk\Api\Request\PddVirtualMedicineCreateNotifyRequest_DrugInfoItem>, "drug_info")
     */
    private $drugInfo;
